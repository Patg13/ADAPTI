...
print("ITS1 Sequences Completion Program (for vsearch based clustering)")
...
#args=parser.parse_args('-otus vsearch.otus.ITS1.fasta -uparse vsearch.otu.up -orifas vsearch.desized.NO_HOMOP.fasta -out vsearch.result.fasta'.split())
...
for i in uparse_otu_lines:
    ...
    otus_dict["OTU_"+str(otu_nb)]=ori_seq
