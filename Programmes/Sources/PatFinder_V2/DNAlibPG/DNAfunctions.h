...
bool DegenerateBasesComp(const char p_upBase,const char p_downBase);

bool NormalBaseDetection(const char p_upBase,const char p_downBase);

bool isDegeneratedPrimer(const std::string& p_primer);
