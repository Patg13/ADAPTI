...
SimpleFastaSequence::SimpleFastaSequence(const std::string& p_nomSeq, const std::string& p_seq, int p_numline): m_nomSeq(PHF::Correct_Seqname(p_nomSeq)),m_seq(PHF::Correct_LineBreak(p_seq)) {
